...
<div class='rp-section-head'><h2>Market Maps</h2><span>Long-Term · Short-Term 1D~20D</span></div><section class='rp-market-map-switcher'><a href='/p/market-history.html'><b>장기 시장지도</b><small>밸류에이션·국면·장기 맥락</small></a><a href='#premarket-mi'><b>단기 시장지도 (1D~20D)</b><small>현재 상태 → 왜? → 무엇을 확인?</small></a></section>
